SuccessPanel = function(items, prizes, violki, bonus_violki) {
  var config = global_config.success_panel; 
  ...
  ok_button.mouse_down = function() { 
    debug.debug("ok_buttwon#mouse_down");
  ...
  var text = Lang.get('success_panel');
